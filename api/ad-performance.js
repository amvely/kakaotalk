...
async function metaAdImagesByHash(accountId, token, hashes){
  ...
  try{
    const rows = await metaGraph(`${metaAccountPath(accountId)}/adimages`, {fields:'hash,url,permalink_url,url_128,width,height', hashes:uniq, limit:500}, token);
    const map={};
